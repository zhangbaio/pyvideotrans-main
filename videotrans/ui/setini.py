    ...
    def setupUi(self, setini):
        ...
        self.notices = {
            ...
            "justify": {
                ...
                "max_audio_speed_rate": "最大音频加速倍数，默认1.25，超过1.8会自动限制以保证自然语速",
        ...
        if defaulelang != 'zh':
            self.notices = {
                ...
                "justify": {
                    ...
                    "max_audio_speed_rate": "Maximum audio speed-up rate. Default: 1.25. Values above 1.8 are clamped for natural speech.",
