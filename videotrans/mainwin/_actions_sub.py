...
class WinActionSub:
    ...
    def set_biaozhun(self):
        ...
        self.main.enable_lipsync.show()
        self.main.remove_hardsub_before_subtitle.show()
    ...
    def set_tiquzimu(self):
        ...
        self.main.enable_lipsync.hide()
        self.main.remove_hardsub_before_subtitle.hide()
    ...
    def disabled_widget(self, type):
        ...
        self.main.enable_lipsync.setDisabled(type)
        self.main.remove_hardsub_before_subtitle.setDisabled(type)
